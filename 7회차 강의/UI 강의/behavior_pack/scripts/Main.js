...
function updateScore(player, name, num) {
...
system.runInterval(() => {
    world.getAllPlayers().forEach((player) => {
        let hp = "000000" + player.getComponent("minecraft:health").currentValue;
        let maxHp = "000000" + player.getComponent("minecraft:health").defaultValue;
        let mp = "000000" + getScore(player, "mp");
        let maxMp = "000000" + getScore(player, "maxMp");
        let xp = "000000" + getScore(player, "xp");
        let maxXp = "000000" + getScore(player, "maxXp");
        let lv = "000000" + getScore(player, "lv");
