export interface IReinforceItem {
    itemName: string
    text: string
    texture: string
    success: number
    ...
    block: string
    plus: Array<Record<string, number>>
    need: Array<Record<string, number>>
    add: Array<Record<string, Record<string, number>>>
}


export const ReinforceItem: Record<string, Array<IReinforceItem>> = {
